...
from Text_summarizer.entity.config_entity import ModelEvaluationConfig
...
class ModelEvaluation:
    ...
    def evaluate(self):
        ...
        score = self.calculate_metric_on_test_ds(
            dataset['test'][0:1], rouge_metric, model_pegasus, tokenizer, batch_size=2, column_text = 'dialogue', column_summary= 'summary'
        )
